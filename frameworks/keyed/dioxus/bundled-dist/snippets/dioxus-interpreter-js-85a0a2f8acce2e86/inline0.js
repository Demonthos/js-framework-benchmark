...
function truthy(val) {
  return val === "true" || val === true;
    ...
    const attr = [];
                    ...
                    }let s = "";let lsp,sp,sl; let c = new TextDecoder();let u8buf,u8bufp;let u32buf,u32bufp;let u16buf,u16bufp;const evt = [];
            ...
            let id,field,len,ptr,bubbles,value,event_name,ns;
